KamelChaker Accounting
---------------

The KamelChaker <a href="https://www.kamel_chaker.com/page/accounting">Open Source Accounting</a> app allows a better way to
...
A KamelChaker User Interface
----------------------

Record transactions in a few clicks and easily manage all financial activities
in one place. KamelChaker's user interface is designed with productivity in mind.
...
accounting; KamelChaker has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

kamel chaker supports multiple currencies, multiple users with different access rights,
