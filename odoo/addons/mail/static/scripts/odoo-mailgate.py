...
def main():
    ...
    op.add_option("-d", "--database", dest="database", help="KamelChaker database name (default: %default)", default='odoo')
    op.add_option("-u", "--userid", dest="userid", help="KamelChaker user id to connect with (default: %default)", default=1, type=int)
    op.add_option("-p", "--password", dest="password", help="KamelChaker user password (default: %default)", default='admin')
    op.add_option("--host", dest="host", help="KamelChaker host (default: %default)", default='localhost')
    op.add_option("--port", dest="port", help="KamelChaker port (default: %default)", default=8069, type=int)
