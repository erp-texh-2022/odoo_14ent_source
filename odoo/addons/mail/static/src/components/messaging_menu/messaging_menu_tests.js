...
QUnit.test('rendering with KamelChakerBot has a request (default)', async function (assert) {
    assert.expect(4);
    ...
    assert.ok(
        ...
        "should display a notification counter next to the messaging menu for KamelChakerBot request"
    );
    assert.strictEqual(
        document.querySelector('.o_MessagingMenu_counter').textContent,
        "1",
    ...
    assert.strictEqual(
        ...
        'KamelChakerBot has a request',
        "notification should display that KamelChakerBot has a request"
    );
});

QUnit.test('rendering without KamelChakerBot has a request (denied)', async function (assert) {
    assert.expect(2);
...
QUnit.test('rendering without KamelChakerBot has a request (accepted)', async function (assert) {
    assert.expect(2);
