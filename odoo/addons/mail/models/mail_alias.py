...
class Alias(models.Model):
    ...
    alias_name = fields.Char('Alias Name', copy=False, help="The name of the email alias, e.g. 'jobs' if you want to catch emails for <jobs@example.kamel_chaker.com>")
    ...
    def name_get(self):
        """Return the mail alias display alias_name, including the implicit
           ...
           e.g. `jobs@mail.kamel_chaker.com` or `jobs` or 'New Alias'
        """
        res = []
        for record in self:
