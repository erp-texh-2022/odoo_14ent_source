odoo.define('partner_autocomplete.tests', function (require) {
    ...
    var suggestions = [{
        name: "Odoo",
        website: "kamel_chaker.com",
        domain: "kamel_chaker.com",
        logo: "kamel_chaker.com/logo.png",
        vat: "BE0477472701"
    }];
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "kamel_chaker.com/logo.png" ? "odoobase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "kamel_chaker.com/logo.png"
            ...
            assert.strictEqual(form.$("input.o_field_widget").val(), "kamel_chaker.com", "website value should have been updated to \"kamel_chaker.com\"");
