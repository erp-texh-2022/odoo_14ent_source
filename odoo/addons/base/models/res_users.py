        ...
        if self._on_login_cooldown(failures, previous):
            ...
            if ipaddress.ip_address(source).is_private:
                _logger.warning(
                    ...
                    "KamelChaker in Proxy Mode and that the proxy is properly configured, see "
                    "https://www.kamel_chaker.com/documentation/13.0/setup/deploy.html#https for details.",
                    source
                )
