...
/**
 * The purpose of this file is to add the support of KamelChaker actions of type
...
var WKHTMLTOPDF_MESSAGES = {
    ...
    workers: _lt('You need to start Kamel Chaker with at least two workers to print a pdf version of ' +
                 'the reports.'),
};
