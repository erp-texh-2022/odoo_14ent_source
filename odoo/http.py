    ...
    * the handler method's result is returned as JSON-RPC ``result`` and
    ...
    def _handle_exception(self, exception):
        ...
        try:
            ...
            error = {
                'code': 200,
                'message': "Kamel Chaker Server Error",
            ...
            if isinstance(exception, AuthenticationError):
                error['code'] = 100
                error['message'] = "kamel chaker session Invalid"
            if isinstance(exception, SessionExpiredException):
                error['code'] = 100
                error['message'] = "kamel chaker session Expired"
...
HTTP methods). See
https://www.kamel_chaker.com/documentation/13.0/reference/http.html#csrf for
more details.
